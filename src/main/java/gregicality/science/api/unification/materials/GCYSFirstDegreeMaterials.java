...
public class GCYSFirstDegreeMaterials {
    ...
    public static void init() {
        ...
        NickelDepletedBraggite = new Material.Builder(3631,"nickel_depleted_braggite")
                .dust()
                .color(0x452402)
                .iconSet(MaterialIconSet.DULL)
                .flags(DISABLE_DECOMPOSITION)
        ...
        InsolublePlatinumGroupResidue  = new Material.Builder(3635,"insoluble_platinum_group_residue")
                .dust()
                .color(0xbf291f)
                .components(Rhodium, 1, Ruthenium, 1, Osmium, 1, Iridium, 1)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(RhRuOsIr)",true);
        TetraamminePalladiumDichlroide  = new Material.Builder(3636,"tetraammine_palladium_dichloride")
                .dust()
                .colorAverage()
                .components(Palladium, 1, Ammonia, 4, Chlorine, 2)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("Pd(NH3)4Cl2",true);
        RhodiumDepletedPlatinumGroupResidue  = new Material.Builder(3637,"rhodium_depleted_platinum_group_residue")
                .dust()
                .colorAverage()
                .components(Ruthenium, 1, Osmium, 1, Iridium, 1)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(RuOsIr)",true);
        RhodiumRutheniumOsmiumDepletedPlatinumGroupResidue  = new Material.Builder(3638,"rhodium_ruthenium_osmium_depleted_platinum_group_residue")
                .dust()
                .color(0x107a70)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(Ir)",true);
        RhodiumSulfateSolution  = new Material.Builder(3639,"rhodium_sulfate_soltion")
                .fluid()
                .colorAverage()
                .components(Ruthenium, 1, Osmium, 1, Iridium, 1)
                .iconSet(MaterialIconSet.SHINY)
                .components(RhodiumSulfate, 3, Water, 1)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(Rh2(SO4)3)(H20)",true);
        CrudeRhodium  = new Material.Builder(3640,"crude_rhodium")
                .dust()
                .color(0x942168)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(Rh)",true);
        DehydroascorbicAcid  = new Material.Builder(3641,"dehydroascorbic_acid")
                .dust()
                .colorAverage()
                .iconSet(MaterialIconSet.SHINY)
        ...
        SodiumHexachlororhodate  = new Material.Builder(3642,"sodium_hexachlororhodate")
                .dust()
                .colorAverage()
                .iconSet(MaterialIconSet.SHINY)
                .components(Chlorine,6,Sodium,1,Rhodium,1)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("Cl6NaRh",true);
        SodiumRhuthenatePerosmateSolution  = new Material.Builder(3643,"sodium_rhuthenate_perosmate_solution")
                .fluid()
                .colorAverage()
                .iconSet(MaterialIconSet.SHINY)
                .components(RhodiumSulfate,3,Water,1)
                ...
                .build()
                .setFormula("(Rh2(SO4)3)(H20)",true);
        RutheniumOsmiumTetroxidesSolution  = new Material.Builder(3644,"ruthenium_osmium_tetroxides_solution")
                .fluid()
                .colorAverage()
                .components(RutheniumTetroxide,4,OsmiumTetroxide,1,SodiumHydroxide,1,Salt,1,Water,1)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(RuO4)(OsO4)(NaOH)(NaCl)(H2O)",true);
        SodiumRuthenatePerosmateSolution  = new Material.Builder(3645,"sodium_ruthenate_perosmate_solution")
                .fluid()
                .colorAverage()
                .components(Sodium,5,RutheniumTetroxide,1,OsmiumTetroxide,1,SodiumHydroxide,1,Water,1)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(Na2RuO4)(Na2OsO4(OH)2)(NaOH)(H2O)",true);
        ChlororuthenicAcidOsmiumTetroxideSolution  = new Material.Builder(3646,"chlororuthenic_acid_osmium_tetroxide_solution")
                .fluid()
                .colorAverage()
                .components(RhodiumSulfate,3,Water,1)
                .iconSet(MaterialIconSet.SHINY)
                ...
                .build()
                .setFormula("(Rh2(SO4)3)(H20)",true);
        ImpureOsmiumTetroxide  = new Material.Builder(3647,"impure_osmium_tetroxide")
                .dust()
                .colorAverage()
                .components(OsmiumTetroxide,1,Salt,1)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(OsO4)(NaCl)",true);
        ChlororuthenicAcid  = new Material.Builder(3648,"chlororuthenic_acid")
                .fluid()
                .colorAverage()
                .components(Hydrogen,3,Ruthenium,1,Chlorine,6,Oxygen,1)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(H2RuCl6)(H2O)",true);
        AmmoniumHexachlororuthenate  = new Material.Builder(3649,"ammonium_hexachlororuthenate")
                .dust()
                .colorAverage()
                .components(Ammonia,2,Ruthenium,1,Chlorine,6)
                .iconSet(MaterialIconSet.DULL)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(NH4)2RuCl6",true);
        SodiumOsmate  = new Material.Builder(3650,"sodium_osmate")
                .dust()
                .colorAverage()
                .components(Oxygen,7,Osmium,1,Sodium,2,Hydrogen,4)
                .iconSet(MaterialIconSet.DULL)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("Na2OsO2(OH)4",true);
        AscorbicAcid  = new Material.Builder(3651,"ascorbic_acid")
                .dust()
                .colorAverage()
        ...
        TetraammineOsmylChloride  = new Material.Builder(3652,"tetraammine_osmyl_chloride")
                .dust()
                .colorAverage()
                .components(Osmium,1,Oxygen,2,Ammonia,4,Chlorine,2)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("OsO2(NH3)4Cl2",true);
        BariumPeroxide  = new Material.Builder(3653,"barium_peroxide")
                .dust()
                .colorAverage()
        ...
        ChloroiridicAcid  = new Material.Builder(3654,"chloroiridic_acid")
                .fluid()
                .colorAverage()
                .components(Hydrogen,2,Iridium,1,Chlorine,1,Water,1)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(H2IrCl6)(H2O)",true);
        AmmoniumHexachloroiridate  = new Material.Builder(3655,"ammonium_hexachloroiridate")
                .dust()
                .colorAverage()
                .components(Nitrogen,8,Hydrogen,8,Iridium,1,Chlorine,6)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("(NH4)2IrCl6",true);
        ZincSulfate  = new Material.Builder(3656,"zinc_sulfate")
                .dust()
                .colorAverage()
                .components(Zinc,1,Sulfur,4,Oxygen,4)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
                .build()
