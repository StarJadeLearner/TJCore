...
//        GTRecipeHandler.removeRecipesByInputs(DISTILLATION_RECIPES, RareEarthChloridesSolution.getFluid(1000));
    ...
    public static void machineRecipes() {
        ...
        ModHandler.addShapedRecipe("distilation_tower_crafting", DISTILLATION_TOWER.getStackForm(),
                ...
                'C', new UnificationEntry(circuit, tierCircuitNames[MV]),
        ...
        ModHandler.addShapedRecipe("cracker_unit_crafting", CRACKER.getStackForm(),
                "CPC","SHS","CPC",
                'C', MetaBlocks.WIRE_COIL.getItemVariant(CUPRONICKEL),
                'P', ELECTRIC_PUMP_MV,
                'S', new UnificationEntry(circuit, tierCircuitNames[MV]),
                'H', MetaTileEntities.HULL[MV].getStackForm()
                );
    }
}
