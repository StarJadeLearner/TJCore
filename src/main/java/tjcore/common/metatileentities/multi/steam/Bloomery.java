...
public class Bloomery extends RecipeMapPrimitiveMultiblockController {
    public Bloomery(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, TJRecipeMaps.BLOOMERY_RECIPES);
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.BACK, RelativeDirection.DOWN)
                ...
                .where('C', states(Blocks.CLAY.getDefaultState()))
                .where('M', states(TJMetaBlocks.MUD_BRICKS.getDefaultState())
                        .or(autoAbilities()))
                .build();
    }

    protected ModularUI.Builder createUITemplate(EntityPlayer entityPlayer) {
        return ModularUI.builder(GuiTextures.PRIMITIVE_BACKGROUND, 176, 184).shouldColor(false)
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new Bloomery(this.metaTileEntityId);
    }
