...
public class TJMetaBlocks {
    ...
    public static BlockCableLongDistance LONG_DIST_CABLE;
    ...
    public static void init() {
        ...
        LONG_DIST_CABLE = new BlockCableLongDistance(Insulation.CABLE_QUADRUPLE);
        LONG_DIST_CABLE.setRegistryName(Insulation.CABLE_QUADRUPLE.getName());
    ...
    public static void registerItemModels() {
        ...
        ModelLoader.setCustomMeshDefinition(Item.getItemFromBlock(LONG_DIST_CABLE), stack -> CableRenderer.INSTANCE.getModelLocation());
    ...
    public static void registerStateMappers() {
        ...
        ModelLoader.setCustomStateMapper(LONG_DIST_CABLE, normalStateMapper);
    }
    ...
    public static void registerOreDict() {
        for (Material pipeMaterial : LONG_DIST_CABLE.getEnabledMaterials()) {
            ItemStack itemStack = LONG_DIST_CABLE.getItem(pipeMaterial);
            OreDictUnifier.registerOre(itemStack, LONG_DIST_CABLE.getPrefix(), pipeMaterial);
        }
    }
