...
public class ItemBlockLongDistanceCable  extends ItemBlockMaterialPipe<Insulation, WireProperties> {

    public ItemBlockLongDistanceCable(BlockCableLongDistance block) {
        super(block);
    }
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World worldIn, @Nonnull List<String> tooltip, @Nonnull ITooltipFlag flagIn) {
        ...
        tooltip.add("Only Outputs to Diodes and Transformers!");
